...
lastindexfile2open = 'OEBPS_cwsa1/CWSA_1_(withoutred)_-_Finalforpress-382.xhtml'
...
with open (lastindexfile2open, "r", encoding="utf-8") as f:
    ...
    for pera in soup.find_all('p', class_="Index-Level-1"):
        ...
        for atext in links:
            ...
            finalfilename2open = 'OEBPS/'+f2open+'xhtml'
            ...
            namedurl = str(strippedname+'/#p'+ str(para_of_indexword)) # for bhartiya book
